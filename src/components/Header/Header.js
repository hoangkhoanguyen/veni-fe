...
export const Header = () => {
  ...
  useEffect(()=>{
    let itemsList = cookieService.get(isLogin? 'itemInCart'+userInfo.userId : 'itemInCart')
    if(itemsList) {
  ...
  useEffect(()=>{
    let itemsList = cookieService.get(isLogin? 'favouriteItems'+userInfo.userId : 'favouriteItems')
    if(itemsList) {
  ...
  return (
    <AnimatePresence>
      <motion.header
            ...
            <div className="row">
              <div className="col-6">
                <div className="header_top_left">
                  <ul>
                    <li><i className="fa fa-envelope"></i> nguyenhoangkhoa2882@gmail.com</li>
                ...
                <div className='header_top_right'>
                  <ul>
                    ...
                    <li className="log-in-out">
                      <a href={path.LOGIN}><i className="fa fa-user"></i> Login</a>
                    </li>}
                    {isLogin && userInfo && <li className='user-name'>
                      {userInfo.firstName + ' ' + userInfo.lastName}
                      <div className="user-option">
                      <span><a href={path.PROFILE}><i class="fas fa-user"></i> My account</a></span>
                        
                        <span onClick={handleLogout}><i className="fas fa-sign-out-alt"></i> Log out</span>
                      </div>
                    </li>}
                  </ul>
                </div>
            ...
            <div className="col-6">
              <div className="nav_bar d-none d-lg-block">
                <ul>
                  ...
                  <li><a href={path.MY_STORE}>Manage My shop</a></li>
                </ul>
              </div>
              ...
              {isShowNavbarMenu && 
              <div className='vertical-navbar-bg' onClick={toggleNavbarMenu}></div>}
              <div className={isShowNavbarMenu?"vertical-navbar show d-lg-none":"vertical-navbar d-lg-none"}>
                <div className="logo">
                ...
                <div><i className="fa fa-envelope"></i> nguyenhoangkhoa2882@gmail.com</div>
        ...
        <div className="container">
          <div className="row">
            <div className="col-9 col-lg-3 mb-3">
              <div className="deparment_container">
                <div className="toggle_deparments_btn" onClick={toggleDepartmentMenu}>
            ...
            <div className="col-12 col-md-8 col-lg-6 mb-3">
              <div className="search-area">
                <input type="text" placeholder='What do you need?' value={searchText} onChange={handleChangeSearchText}/>
